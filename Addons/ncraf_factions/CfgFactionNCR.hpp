...
class CfgVehicles {
	...
	class ncraf_ncr_base: armor_ncr_trooper_01_body
	{
		...
		class ncraf_ncr_recruit: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		...
		class ncraf_ncr_trooper_conscript: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper_melee: O_Soldier_Melee
	{
		...
		class ncraf_ncr_mp: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_mp_melee: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper_autorifle: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_trooper_grenadier: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper_mg: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper_mg_asst: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_trooper_launcher: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper_launcher_asst: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_at_rifle: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_marksman: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_medic: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper_tl: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper_sl: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper_junior_officer: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper_senior_officer: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper_staff_officer: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_trooper_pilot: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_trooper_crewman: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_sailor: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_marine: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_marine_cqc: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		class ncraf_ncr_marine_autorifleman: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_marine_medic: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_marine_tl: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_marine_sl: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_marine_officer: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_heavy_trooper: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_heavy_trooper_cqc: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_heavy_trooper_melee: O_Soldier_Melee
	{
		...
		faction = "ncraf_ncr";
		genericNames = "NATOMen";
		displayName = "Heavy Trooper (Melee)";		// The name of the soldier, which is displayed in the editor.
		textPlural = "infantry";
		textSingular = "infantry";
		nameSound = "veh_infantry_s";
		role = "CQC";
	...
	class ncraf_ncr_heavy_trooper_mg: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		faction = "ncraf_ncr";
		genericNames = "NATOMen";
		displayName = "Heavy Trooper (MG)";		// The name of the soldier, which is displayed in the editor.
		textPlural = "infantry";
		textSingular = "infantry";
		nameSound = "veh_infantry_MG_s";
		role = "Machinegunner";
	...
	class ncraf_ncr_heavy_trooper_tl: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_heavy_trooper_sl: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		faction = "ncraf_ncr";
		genericNames = "NATOMen";
		displayName = "Heavy Squad Leader";		// The name of the soldier, which is displayed in the editor.
		textPlural = "infantry";
		textSingular = "infantry";
		nameSound = "veh_infantry_s";
		role = "SquadLeader";
	...
	class ncraf_ncr_heavy_trooper_officer: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
		...
		faction = "ncraf_ncr";
		genericNames = "NATOMen";
		displayName = "Heavy Officer";		// The name of the soldier, which is displayed in the editor.
		textPlural = "officers";
		textSingular = "officer";
		nameSound = "veh_infantry_s";
		role = "Officer";
	...
	class ncraf_ncr_civil_ranger_01: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_civil_ranger_02: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_civil_ranger_03: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_civil_ranger_04: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_civil_ranger_05: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_civil_ranger_06: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_patrol_ranger_pistol: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_patrol_ranger_repeater: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_patrol_ranger_rifle: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_patrol_ranger_automatic: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_vet_ranger_pistol: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_vet_ranger_repeater: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_vet_ranger_at: ncraf_ncr_base
	{
		author = "Archr";	// The name of the author of the asset, which is displayed in the editor.
		scope = 2;				// 2 = class is available in the editor; 1 = class is unavailable in the editor, but can be accessed via a macro; 0 = class is unavailable (and used for inheritance only).
		scopeCurator = 2;		// 2 = class is available in Zeus; 0 = class is unavailable in Zeus.
	...
	class ncraf_ncr_willys: LIB_US_NAC_Willys_MB
	{
		...
		{
			"ncraf\addons\ncraf_vehicles\data\willys_ncr.paa",
		};
	};
	...
	class ncraf_stuart_ncr: LIB_M3A3_Stuart
	{
		...
		hiddenSelectionsTextures[] = 
		{
			"ncraf\addons\ncraf_vehicles\data\stuart_ncr.paa",
		};
	};
